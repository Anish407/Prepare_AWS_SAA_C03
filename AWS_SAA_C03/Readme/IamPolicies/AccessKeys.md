...
> We can generate a credential reports to get details about the users, credentails , policies and more for auditing purposes. **We only get new data in the credentials reports every 4 hours**